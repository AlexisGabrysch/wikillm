...
# from databasebis import DatabaseManagerQuizz
# import hashlib
# import random
# from datetime import datetime
# import os

# def add_simulated_users(db: DatabaseManagerQuizz):
...
#         {"first_name": "root", "last_name": "root", "username": "root", "password": "root", "super_user": 1}
#     ]
#     for user in users:
...
# def add_simulated_questions(db: DatabaseManagerQuizz):
#     questions = [
#         {
...
# def add_simulated_quizzes(db: DatabaseManagerQuizz):
...
# def delete_all_data(db: DatabaseManagerQuizz):
